...
class ProyekController extends Controller
{
    ...
    public function ajukanSelesai(Kontrak $proyek)
    {
        ...
        // Tandai bahwa konsultan sudah mengajukan penyelesaian
