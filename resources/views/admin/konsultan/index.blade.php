...
<div class="ibox">
    <div class="ibox-head">
        <div class="ibox-title">Data Konsultan</div>
        <div class="ibox-tools">
            <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#createModal"><i class="fa fa-plus"></i> Tambah Konsultan</button>
        </div>
    </div>
    <div class="ibox-body">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <form action="{{ route('admin.konsultan.destroy', $item->id) }}" method="POST" class="d-inline">
                                @csrf @method('DELETE')
                    ...
                    <div class="modal fade" id="editModal{{ $item->id }}">
                        <div class="modal-dialog">
                            <form action="{{ route('admin.konsultan.update', $item->id) }}" method="POST">
                                @csrf @method('PUT')
                                <div class="modal-content">
                                    <div class="modal-header"><h5 class="modal-title">Edit Konsultan</h5><button type="button" class="close" data-dismiss="modal">&times;</button></div>
...
<div class="modal fade" id="createModal">
    <div class="modal-dialog">
        <form action="{{ route('admin.konsultan.store') }}" method="POST">
            @csrf
            <div class="modal-content">
                <div class="modal-header"><h5 class="modal-title">Tambah Konsultan Baru</h5><button type="button" class="close" data-dismiss="modal">&times;</button></div>
                <div class="modal-body">
