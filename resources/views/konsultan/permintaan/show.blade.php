        ...
        <div class="ibox">
            ...
            <div class="ibox-body">
                ...
                <div class="alert alert-info">
                    ...
                    <form action="{{ route('konsultan.permintaan.terima', $permintaan->id) }}" method="POST" class="mt-3">
                        @csrf
                ...
                @if($permintaan->status === \App\Enums\PermintaanStatus::DITERIMA_KONSULTAN || $permintaan->status === \App\Enums\PermintaanStatus::DISUSUN_RAB)
                <div class="alert alert-success">
                    <p>Anda telah menerima proyek ini. Langkah selanjutnya adalah menyusun dan mengajukan Rencana Anggaran Biaya (RAB).</p>
                    <a href="{{ route('konsultan.rab.create', $permintaan->id) }}" class="btn btn-primary btn-block mt-3"><i class="fa fa-calculator"></i> Susun RAB Sekarang</a>
                </div>
                @endif
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @elseif($permintaan->sumber_denah === 'dibuatkan_konsultan')
                                    <span class="badge badge-warning">Konsultan Harus Merancang</span>
                            ...
                            <td>
                                ...
                                @else
                                    @if($permintaan->sumber_denah === 'dibuatkan_konsultan')
                                        <span class="text-warning"><i class="fa fa-clock-o"></i> Menunggu Anda Mengunggah Sketsa (saat submit RAB)</span>
                                    @else
        ...
        <div class="ibox">
            <div class="ibox-head">
                ...
                <div class="ibox-tools">
                    <a href="{{ route('konsultan.rab.show', $permintaan->rab->id) }}" class="btn btn-info btn-sm"><i class="fa fa-external-link"></i> Kelola RAB</a>
                </div>
            </div>
            <div class="ibox-body">
...
<div class="modal fade" id="tolakModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <form action="{{ route('konsultan.permintaan.tolak', $permintaan->id) }}" method="POST">
            @csrf
