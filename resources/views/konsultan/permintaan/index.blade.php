...
<div class="row">
    <div class="col-12">
        <div class="ibox">
            ...
            <div class="ibox-body">
                <form method="GET" action="{{ route('konsultan.permintaan.index') }}" class="mb-4">
                    ...
                    <table class="table table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('konsultan.permintaan.show', $item->id) }}" class="btn btn-info btn-xs"><i class="fa fa-eye"></i> Detail</a>
                                </td>
                            </tr>
                            @empty
                            <tr>
