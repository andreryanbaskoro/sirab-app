            ...
            <div class="ibox-body">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ $tab === 'jasa' ? 'active' : '' }}"
                           ...
                           aria-selected="{{ $tab === 'jasa' ? 'true' : 'false' }}">
                            <i class="fa fa-hand-holding-dollar"></i> Jasa Konsultan Saya
                        </a>
                    </li>
                </ul>
                ...
                <div class="tab-content mt-3" id="anggaranTabsContent">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form action="{{ route('konsultan.anggaran.pekerjaan.destroy', $item->id) }}"
                    ...
                    <div class="tab-pane fade {{ $tab === 'jasa' ? 'show active' : '' }}"
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h6 class="mb-0 font-weight-bold">
                                <i class="fa fa-hand-holding-dollar text-warning mr-1"></i> Daftar Harga Jasa Konsultan Saya
                            </h6>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form action="{{ route('konsultan.anggaran.jasa.destroy', $item->id) }}"
                                                  method="POST" class="d-inline">
                                                @csrf @method('DELETE')
                                                <button type="button" class="btn btn-danger btn-xs btn-delete" title="Hapus">
                                                    <i class="fa fa-trash"></i>
                                    ...
                                    @empty
                                    <tr>
                                        <td colspan="5" class="text-center text-muted">Belum ada data harga jasa konsultan.</td>
                                    </tr>
                                    @endforelse
                                </tbody>
                            </table>
...
<!-- Modals for Material removed because it is read-only for Konsultan -->

{{-- ─── CREATE: Pekerjaan ─── --}}
<div class="modal fade" id="createPekerjaanModal" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg" role="document">
        <form action="{{ route('konsultan.anggaran.pekerjaan.store') }}" method="POST">
            @csrf
...
{{-- ─── CREATE: Harga Jasa Konsultan ─── --}}
<div class="modal fade" id="createJasaModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <form action="{{ route('konsultan.anggaran.jasa.store') }}" method="POST">
            @csrf
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><i class="fa fa-hand-holding-dollar mr-1 text-warning"></i> Tambah Harga Jasa Konsultan</h5>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <div class="form-group">
...
{{-- ─── EDIT: Harga Jasa Konsultan (satu modal, diisi via JS) ─── --}}
<div class="modal fade" id="editJasaModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <form id="formEditJasa" action="" method="POST">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><i class="fa fa-pencil mr-1 text-warning"></i> Edit Harga Jasa Konsultan</h5>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <div class="modal-body">
                    <div class="form-group">
...
$(document).ready(function () {
    ...
    $('#editMaterialModal').on('show.bs.modal', function (e) {
        ...
        form.attr('action', '/konsultan/anggaran/material/' + id);
    ...
    $('#editPekerjaanModal').on('show.bs.modal', function (e) {
        ...
        form.attr('action', '/konsultan/anggaran/pekerjaan/' + id);
    ...
    // ── Modal Edit: Harga Jasa Konsultan ────────────────────────────────────────
    $('#editJasaModal').on('show.bs.modal', function (e) {
        var btn  = $(e.relatedTarget);
        var id   = btn.data('id');
        var form = $('#formEditJasa');

        form.attr('action', '/konsultan/anggaran/jasa/' + id);
