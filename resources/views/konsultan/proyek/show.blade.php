...
<div class="page-heading">
    ...
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ route('konsultan.dashboard') }}"><i class="fa-solid fa-home"></i></a></li>
        <li class="breadcrumb-item"><a href="{{ route('konsultan.proyek.index') }}">Proyek Berjalan</a></li>
            ...
            <div class="ibox">
                ...
                <div class="ibox-body">
                    <ul class="list-group list-group-divider list-group-full">
                        <li class="list-group-item flexbox">
                            ...
                            <span class="font-weight-bold text-right">
                                ...
                                <a href="{{ route('konsultan.rab.download-kontrak', $proyek->rab_id) }}" class="btn btn-outline-primary btn-sm mt-1" target="_blank"><i class="fa fa-download"></i> Unduh Kontrak</a>
                            </span>
                        </li>
                        <li class="list-group-item flexbox">
                            <span>Konsumen</span>
                    ...
                    <div class="mt-4 text-center">
                        <form action="{{ route('konsultan.proyek.ajukan-selesai', $proyek->id) }}" method="POST">
                            @csrf
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($bayar->status == 'menunggu_verifikasi')
                                        <form action="{{ route('konsultan.pembayaran.verifikasi', $bayar->id) }}" method="POST" class="d-inline">
                                            @csrf
