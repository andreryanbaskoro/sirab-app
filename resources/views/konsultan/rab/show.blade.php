        ...
        <div class="ibox">
            ...
            <div class="ibox-body">
                ...
                <div class="alert alert-info">
                    ...
                    <form action="{{ route('konsultan.rab.submit', $rab->id) }}" method="POST" class="mt-3" enctype="multipart/form-data">
                        @csrf
                    ...
                    <a href="{{ route('konsultan.rab.create', $rab->permintaan_id) }}" class="btn btn-outline-primary btn-block mt-2"><i class="fa fa-pencil"></i> Edit Ulang Draft</a>
                </div>
                @endif
                ...
                <div class="alert alert-danger">
                    ...
                    <a href="{{ route('konsultan.rab.create', $rab->permintaan_id) }}" class="btn btn-primary btn-block mt-3"><i class="fa fa-refresh"></i> Revisi RAB</a>
                </div>
                @endif
                ...
                <div class="alert alert-success">
                    ...
                    <a href="{{ route('konsultan.permintaan.show', $rab->permintaan_id) }}" class="btn btn-primary btn-block mt-2"><i class="fa fa-file-text"></i> Lihat Kontrak</a>
                    @endif
                </div>
                @endif
            ...
            <div class="ibox-head">
                ...
                <div class="ibox-tools">
                    @if(in_array($rab->status->value, ['disetujui']))
                        <a href="{{ route('konsultan.rab.pdf', $rab->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-file-pdf-o"></i> Cetak PDF</a>
                    @endif
                </div>
            </div>
            <div class="ibox-body">
                ...
                <div class="mt-4 p-3 bg-light border-left-info border-left-3">
                    ...
                    <p class="mb-0">{{ $rab->catatan_konsultan }}</p>
                </div>
                @endif
            </div>
        </div>
